...
for domain in list:
    ...
    # raw_xml = dom.XMLDesc()
    mac_addresses[domain.name()], _ = getMacAddresses(dom, domain.name())
...
#     xmls[vm].create()
print(mac_addresses)
# if not os.path.exists('/home/result.txt'):
#   os.makedirs('/home/result.txt')
with open('/tmp/result.txt', mode='w+') as file:
